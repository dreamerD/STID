...
def parse_args():
    ...
    parser.add_argument('-c', '--cfg', default='basicts/options/STID_test/STID_PEMS04.py', help='training config')
    ...
    # parser.add_argument('-c', '--cfg', default='basicts/options/GWNet/GWNet_PEMS04.py', help='training config')
    # parser.add_argument('-c', '--cfg', default='basicts/options/Dlinear/Dlinear_PEMS04.py', help='training config')
