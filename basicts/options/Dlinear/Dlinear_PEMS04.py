...
# architecture 
from basicts.archs.Dlinear_arch import Dlinear
# runner
...
# ================= general ================= #
CFG.DESCRIPTION = 'Dlinear model configuration without DiW embedding'
...
CFG.MODEL.FROWARD_FEATURES = [0, 1, 2, 3, 4]            # traffic speed, time in day
