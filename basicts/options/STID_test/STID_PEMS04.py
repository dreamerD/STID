...
# architecture
from basicts.archs.STID_arch_test import STID_test
# runner
from basicts.runners.STID_runner_his import STIDRunner
from basicts.data.base_dataset_his import BaseDataset
...
# ================= model ================= #
CFG.MODEL = EasyDict()
CFG.MODEL.NAME = 'STID_test_v16'
CFG.MODEL.ARCH = STID_test
CFG.MODEL.PARAM = {
    "num_nodes": 307,
    'input_len': 12,
    'input_dim': 5,
...
# traffic speed, time in day
CFG.MODEL.FROWARD_FEATURES = [0, 1, 2, 3, 4]
...
# read data
CFG.TRAIN.DATA.DIR = 'datasets/' + CFG.DATASET_NAME + "/his"
